#
# Sphinx config file for PlexMediaFixup project.
#
...
project = u'PlexMediaFixup'
#copyright = u''
author = u"Andreas Maier"

# The short description of the package.
_short_description = u"Run configurable fixups against the media database of a Plex Media Server"
...
htmlhelp_basename = 'plexmediafixup_doc'
...
latex_documents = [
    (master_doc, 'plexmediafixup.tex', _short_description, author, 'manual'),
]
...
man_pages = [
    (master_doc, 'plexmediafixup', _short_description, [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'plexmediafixup', _short_description,
     author, 'plexmediafixup', _short_description,
     'Miscellaneous'),
]
        ...
        try:
            ...
            if 'methods' in self.options:
                ...
                for method in methods:
                    ...
                    if def_module_name.startswith('plexmediafixup'):
