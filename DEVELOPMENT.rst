...
3. Install the project for development.
   This will install an d required Python packages into the active Python
   environment:
...
7.  On GitHub, create a Pull Request for branch ``release_$MNP``. This will
...
9.  If any of the tests mentioned above fails, fix the problem and iterate
...
13. If you released the master branch it will be fixed separately, so it needs
    a new fix stream.
